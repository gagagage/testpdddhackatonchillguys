document.addEventListener("DOMContentLoaded", () => {
    ...
    const levels = [
        questions.slice(0, 5), // Уровень 1
        questions.slice(5, 10) // Уровень 2
    ];
    ...
    function calculateStars(score) {
        if (score >= 2000) return "⭐️⭐️⭐️⭐️⭐️"; // 5 звезд
        if (score >= 1500) return "⭐️⭐️⭐️⭐️"; // 4 звезды
        if (score >= 1000) return "⭐️⭐️⭐️"; // 3 звезды
        if (score >= 500) return "⭐️⭐️"; // 2 звезды
        return "⭐️"; // 1 звезда
    }
